...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.formatShareResultsOutput = void 0;
const v1_1 = __webpack_require__(7666);
const utils_1 = __webpack_require__(67533);
function formatShareResultsOutput(outputMeta) {
    return utils_1.colors.info.bold(v1_1.shareResultsOutput(outputMeta));
}
...
const INDENT = '  ';
function formatIacTestSummary(testData, outputMeta) {
...
function formatCountsSection(testData) {
    ...
    countsSectionProperties.push(`${INDENT}Total issues: ${utils_1.colors.info.bold(`${totalIssuesCount}`)} [ ${utils_1.colors.severities.critical(`${issueCountsBySeverities.critical} critical`)}, ${utils_1.colors.severities.high(`${issueCountsBySeverities.high} high`)}, ${utils_1.colors.severities.medium(`${issueCountsBySeverities.medium} medium`)}, ${utils_1.colors.severities.low(`${issueCountsBySeverities.low} low`)} ]`);
...
exports.colors = {
    ...
    title: chalk_1.default.white.bold,
};
